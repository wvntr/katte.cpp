...
tests/CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.o: /workspace/tests/test-tokenizer-1-bpe.cpp
tests/CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.o: tests/CMakeFiles/test-tokenizer-1-bpe.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/workspace/build-katte/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.o"
	cd /workspace/build-katte/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.o -MF CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.o.d -o CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.o -c /workspace/tests/test-tokenizer-1-bpe.cpp
...
tests/CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.i: cmake_force
	...
	cd /workspace/build-katte/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /workspace/tests/test-tokenizer-1-bpe.cpp > CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.i
...
tests/CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.s: cmake_force
	...
	cd /workspace/build-katte/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /workspace/tests/test-tokenizer-1-bpe.cpp -o CMakeFiles/test-tokenizer-1-bpe.dir/test-tokenizer-1-bpe.cpp.s
...
bin/test-tokenizer-1-bpe: bin/libllama-common.so.0.4.1
bin/test-tokenizer-1-bpe: bin/libllama.so.0.4.1
bin/test-tokenizer-1-bpe: bin/libggml.so.0.24.0
bin/test-tokenizer-1-bpe: bin/libggml-cpu.so.0.24.0
bin/test-tokenizer-1-bpe: bin/libggml-base.so.0.24.0
...
bin/test-tokenizer-1-bpe: tests/CMakeFiles/test-tokenizer-1-bpe.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/workspace/build-katte/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../bin/test-tokenizer-1-bpe"
	cd /workspace/build-katte/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-tokenizer-1-bpe.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/test-tokenizer-1-bpe.dir/clean:
	cd /workspace/build-katte/tests && $(CMAKE_COMMAND) -P CMakeFiles/test-tokenizer-1-bpe.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/test-tokenizer-1-bpe.dir/clean

tests/CMakeFiles/test-tokenizer-1-bpe.dir/depend:
	cd /workspace/build-katte && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspace /workspace/tests /workspace/build-katte /workspace/build-katte/tests /workspace/build-katte/tests/CMakeFiles/test-tokenizer-1-bpe.dir/DependInfo.cmake --color=$(COLOR)
