...
tests/CMakeFiles/test-chat-template.dir/test-chat-template.cpp.o: /workspace/tests/test-chat-template.cpp
tests/CMakeFiles/test-chat-template.dir/test-chat-template.cpp.o: tests/CMakeFiles/test-chat-template.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/workspace/build-katte/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/test-chat-template.dir/test-chat-template.cpp.o"
	cd /workspace/build-katte/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/test-chat-template.dir/test-chat-template.cpp.o -MF CMakeFiles/test-chat-template.dir/test-chat-template.cpp.o.d -o CMakeFiles/test-chat-template.dir/test-chat-template.cpp.o -c /workspace/tests/test-chat-template.cpp
...
tests/CMakeFiles/test-chat-template.dir/test-chat-template.cpp.i: cmake_force
	...
	cd /workspace/build-katte/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /workspace/tests/test-chat-template.cpp > CMakeFiles/test-chat-template.dir/test-chat-template.cpp.i
...
tests/CMakeFiles/test-chat-template.dir/test-chat-template.cpp.s: cmake_force
	...
	cd /workspace/build-katte/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /workspace/tests/test-chat-template.cpp -o CMakeFiles/test-chat-template.dir/test-chat-template.cpp.s
...
bin/test-chat-template: bin/libllama-common.so.0.4.1
bin/test-chat-template: common/libllama-common-base.a
bin/test-chat-template: bin/libllama.so.0.4.1
bin/test-chat-template: bin/libggml.so.0.24.0
bin/test-chat-template: bin/libggml-cpu.so.0.24.0
bin/test-chat-template: bin/libggml-base.so.0.24.0
bin/test-chat-template: tests/CMakeFiles/test-chat-template.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/workspace/build-katte/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../bin/test-chat-template"
	cd /workspace/build-katte/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-chat-template.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/test-chat-template.dir/clean:
	cd /workspace/build-katte/tests && $(CMAKE_COMMAND) -P CMakeFiles/test-chat-template.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/test-chat-template.dir/clean

tests/CMakeFiles/test-chat-template.dir/depend:
	cd /workspace/build-katte && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspace /workspace/tests /workspace/build-katte /workspace/build-katte/tests /workspace/build-katte/tests/CMakeFiles/test-chat-template.dir/DependInfo.cmake --color=$(COLOR)
